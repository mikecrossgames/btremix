label ApartmentEndingCbajaending2:
    ...
    if johan_leyna_sex == 2:
        ...
        Leyna "... Great"
        scene black with dissolve
        show calta1cont1 with dissolve
        Leyna "Well... I'm here"
        ...
        scene black with dissolve
        show calta1cont5 with dissolve
        ...
        show calta1cont7 with dissolve
    ...
    if johan_leyna_sex == 1:
        ...
        scene black with dissolve
        show calta2cont4 with dissolve
        "Days later..."
        ...
        "So we will see you soon and don't forget that this is not the end of Johan and Leyna's story, you will see them in Bawdy Traditions 2"
        "See you soon!"
        image creditosdavid_webm = Movie(play="movies/creditosdavid.webm", loop=True)
        scene creditosdavid_webm
        pause
        $ game_over = True
    $ game_over = True
    return
...
label ApartmentEndingCbajaending2_v2:
    ...
    Johan "!!! Shit..."
    scene black with dissolve
    show cmedia4cont1 with dissolve
    "Days later..."
