...
label Bar2ToTown2Base:
    call PlaySound("sound", "audio/Move1.ogg", volume=0.9, no_loop=True) from _call_Bar2EV001_PlaySound
    call TransferPlayer("Town2", "Bar2EV001", 25, 46, direction=2) from _call_Bar2EV001_TransferPlayer
    $ resolve_scene()
    return False

label Bar2ToTown2(play_event = True, trigger = None): # event
    if is_erased("Bar2ToTown2"):
        return None
    elif trigger == "event":
        call PlayEvent(play_event, "Bar2ToTown2Base", "Bar2ToTown2") from _call_Bar2ToTown2_PlayEvent
        return (0, "", "Bar2ToTown2")
    return None

label Bar2barman_0:
    Barman "You need anything?"
    return False
...
label Bar2barman_3:
    ...
    call PlaySound("sound", "audio/Equip2.ogg", volume=0.9, no_loop=True) from _call_Bar2barman_3_PlaySound
    ...
    $ bar_work = 1
    call GalleryViewed("trabajobar") from _call_Bar2barman_3_GalleryViewed
    call TransferPlayer("Town2", "Bar2barman_3", 22, 43, direction=0) from _call_Bar2barman_3_TransferPlayer
    $ resolve_scene()
    Leyna "Where has Johan gone?... anyway, I should go to the inn to rest, tomorrow I have another day of work"
    return False

label Bar2barman_4:
    Barman "See you tomorrow"
    return False
...
label Bar2barman_5(menu_choice = None):
    ...
    if menu_choice == _("I will work like this "):
        ...
        call GalleryViewed("trabajobar2") from _call_Bar2barman_5_GalleryViewed
        ...
        call PlaySound("bgs", "audio/audio follar.ogg", volume=0.9, no_loop=False) from _call_Bar2barman_5_PlaySound
        $ resolve_scene()
        Leyna "HMmmaaaa!!"
        ...
        call PlaySound("bgs", "audio/audio follar.ogg", volume=0.9, no_loop=False) from _call_Bar2barman_5_PlaySound_1
        $ resolve_scene()
        ...
        call PlaySound("bgs", "audio/audio follar.ogg", volume=0.9, no_loop=False) from _call_Bar2barman_5_PlaySound_2
        $ resolve_scene()
        ...
        Barman "... Sure"
        call TransferPlayer("Town2", "Bar2barman_5", 21, 37, direction=8) from _call_Bar2barman_5_TransferPlayer
        $ resolve_scene()
        call PauseForBalloon("Bar2barman_5") from _call_Bar2barman_5_PauseForBalloon
        ...
        $ fade_out()
        call ChangePartyMember("Leyna", False) from _call_Bar2barman_5_ChangePartyMember
        call ChangePartyMember("Johan", True) from _call_Bar2barman_5_ChangePartyMember_1
        call TransferPlayer("Town2", "Bar2barman_5", 28, 22, direction=2) from _call_Bar2barman_5_TransferPlayer_1
        $ fade_in()
        $ resolve_scene()
        "Some time later"
        Johan "Where is Leyna? Maybe she is still working I'll go to the bar to see what's going on"
        $ bar_work = 3
        $ set_self_switch("Bar2","Bar2barman","A",True)
        ...
        call PlaySound("bgs", "audio/audio follar.ogg", volume=0.9, no_loop=False) from _call_Bar2barman_5_PlaySound_3
        $ resolve_scene()
        ...
        if menu_choice == _("Keep still"):
            ...
            Leyna "Yes... see you tomorrow"
            Barman "... Sure"
            call TransferPlayer("Town2", "Bar2barman_5", 21, 37, direction=8) from _call_Bar2barman_5_TransferPlayer_2
            $ resolve_scene()
            call PauseForBalloon("Bar2barman_5") from _call_Bar2barman_5_PauseForBalloon_1
            Leyna "That was a bit of an experience... anyway, I'm going to rest and and tomorrow will be another day"
            $ fade_out()
            call ChangePartyMember("Leyna", False) from _call_Bar2barman_5_ChangePartyMember_2
            call ChangePartyMember("Johan", True) from _call_Bar2barman_5_ChangePartyMember_3
            call TransferPlayer("Town2", "Bar2barman_5", 28, 22, direction=2) from _call_Bar2barman_5_TransferPlayer_3
            $ fade_in()
            $ resolve_scene()
            "Some time later"
            Johan "Where is Leyna? Maybe she is still working I'll go to the bar to see what's going on"
            ...
            Leyna "Yes... see you tomorrow"
            Barman "... Sure"
            call TransferPlayer("Town2", "Bar2barman_5", 21, 37, direction=8) from _call_Bar2barman_5_TransferPlayer_4
            $ resolve_scene()
            call PauseForBalloon("Bar2barman_5") from _call_Bar2barman_5_PauseForBalloon_2
            Leyna "That was a bit of an experience... anyway, I'm going to rest and and tomorrow will be another day"
            $ fade_out()
            call ChangePartyMember("Leyna", False) from _call_Bar2barman_5_ChangePartyMember_4
            call ChangePartyMember("Johan", True) from _call_Bar2barman_5_ChangePartyMember_5
            call TransferPlayer("Town2", "Bar2barman_5", 28, 22, direction=2) from _call_Bar2barman_5_TransferPlayer_5
            $ fade_in()
            $ resolve_scene()
            "Some time later"
            Johan "Where is Leyna? Maybe she is still working I'll go to the bar to see what's going on"
...
label Bar2barman_6:
    Barman "Everything okay?"
    return False

label Bar2barman_7:
    "Bar man: After yesterday's shift you deserve a day off, enjoy it!"
    Leyna "Thanks boss!"
    "Bar man: Hehehehehe boss?...I like the sound of it, after you leave I'll have to hire another pretty girl to call me that"
    return False
...
label Bar2barman(play_event = True, trigger = None): # event
    if is_erased("Bar2barman"):
        return None
    elif trigger == "event" and switch("festival_final"):
        call PlayEvent(play_event, "Bar2barman_8", "Bar2barman") from _call_Bar2barman_8_PlayEvent
        return (1, "", "Bar2barman_8")
    elif trigger == "event" and switch("party_at_festival"):
        call PlayEvent(play_event, "Bar2barman_7", "Bar2barman") from _call_Bar2barman_7_PlayEvent
        return (1, "", "Bar2barman_7")
    elif trigger == "event" and self_switch("Bar2","Bar2barman","A"):
        call PlayEvent(play_event, "Bar2barman_6", "Bar2barman") from _call_Bar2barman_6_PlayEvent
        return (1, "", "Bar2barman_6")
    elif trigger == "event" and bar_work >= 2:
        call PlayEvent(play_event, "Bar2barman_5", "Bar2barman") from _call_Bar2barman_5_PlayEvent
        return (1, "", "Bar2barman_5")
    elif trigger == "event" and bar_work >= 1:
        call PlayEvent(play_event, "Bar2barman_4", "Bar2barman") from _call_Bar2barman_4_PlayEvent
        return (1, "", "Bar2barman_4")
    elif trigger == "event" and switch("flashback"):
        call PlayEvent(play_event, "Bar2barman_3", "Bar2barman") from _call_Bar2barman_3_PlayEvent
        return (1, "", "Bar2barman_3")
    elif trigger == "event" and leyna_work >= 3:
        call PlayEvent(play_event, "Bar2barman_2", "Bar2barman") from _call_Bar2barman_2_PlayEvent
        return (1, "", "Bar2barman_2")
    elif trigger == "event" and leyna_work >= 2:
        call PlayEvent(play_event, "Bar2barman_1", "Bar2barman") from _call_Bar2barman_1_PlayEvent
        return (1, "", "Bar2barman_1")
    elif trigger == "event":
        call PlayEvent(play_event, "Bar2barman_0", "Bar2barman") from _call_Bar2barman_0_PlayEvent
        return (1, "", "Bar2barman_0")
    return None

label Bar2NPCMachineBase:
    Villager "This shit has swallowed a coin and won't get me the sandwich."
    return False

label Bar2NPCMachine(play_event = True, trigger = None): # event
    if is_erased("Bar2NPCMachine"):
        return None
    elif trigger == "event":
        call PlayEvent(play_event, "Bar2NPCMachineBase", "Bar2NPCMachine") from _call_Bar2NPCMachine_PlayEvent
        return (1, "", "Bar2NPCMachine")
    return None

label Bar2NPCBuyDrinkBase:
    Villager "Do you want a beer? I pay."
    return False

label Bar2NPCBuyDrink(play_event = True, trigger = None): # event
    if is_erased("Bar2NPCBuyDrink"):
        return None
    elif trigger == "event":
        call PlayEvent(play_event, "Bar2NPCBuyDrinkBase", "Bar2NPCBuyDrink") from _call_Bar2NPCBuyDrink_PlayEvent
        return (1, "", "Bar2NPCBuyDrink")
    return None

label Bar2NPCOldDrunkBase:
    DrunkVillager "... too much ... beer..."
    return False

label Bar2NPCOldDrunk(play_event = True, trigger = None): # event
    if is_erased("Bar2NPCOldDrunk"):
        return None
    elif trigger == "event":
        call PlayEvent(play_event, "Bar2NPCOldDrunkBase", "Bar2NPCOldDrunk") from _call_Bar2NPCOldDrunk_PlayEvent
        return (1, "", "Bar2NPCOldDrunk")
    return None

label Bar2NPCDadComplainsBase:
    Villager "My father is complaining all day long"
    return False

label Bar2NPCDadComplains(play_event = True, trigger = None): # event
    if is_erased("Bar2NPCDadComplains"):
        return None
    elif trigger == "event":
        call PlayEvent(play_event, "Bar2NPCDadComplainsBase", "Bar2NPCDadComplains") from _call_Bar2NPCDadComplains_PlayEvent
        return (1, "", "Bar2NPCDadComplains")
    return None

label Bar2NPCBadFoodBase:
    Villager "The food in this club is terrible..."
    return False

label Bar2NPCBadFood(play_event = True, trigger = None): # event
    if is_erased("Bar2NPCBadFood"):
        return None
    elif trigger == "event":
        call PlayEvent(play_event, "Bar2NPCBadFoodBase", "Bar2NPCBadFood") from _call_Bar2NPCBadFood_PlayEvent
        return (1, "", "Bar2NPCBadFood")
    return None

label Bar2WowGuysWhatACoincidence_0(menu_choice = None):
    call Movement("Bar2EV012_0", "player", ["U","U"]) from _call_Bar2EV012_0_Movement
    $ resolve_scene()
    call PauseForBalloon("Bar2EV012_0") from _call_Bar2EV012_0_PauseForBalloon
    ...
    call PlaySound("sound", "audio/Equip2.ogg", volume=0.9, no_loop=True) from _call_Bar2EV012_0_PlaySound
    $ resolve_scene()
    ...
    call PlaySound("sound", "audio/Equip2.ogg", volume=0.9, no_loop=True) from _call_Bar2EV012_0_PlaySound_1
    $ resolve_scene()
    ...
    call PlaySound("sound", "audio/Equip2.ogg", volume=0.9, no_loop=True) from _call_Bar2EV012_0_PlaySound_2
    $ resolve_scene()
    ...
    call PlaySound("sound", "audio/Jump1.ogg", volume=0.9, no_loop=True) from _call_Bar2EV012_0_PlaySound_3
    $ resolve_scene()
    ...
    call GalleryViewed("apuesta") from _call_Bar2EV012_0_GalleryViewed
    ...
    if menu_choice == _("STOP!"):
        ...
        $ erase_picture(13)
        $ erase_picture(14)
        call TransferPlayer("Town2", "Bar2EV012_0", 28, 22, direction=2) from _call_Bar2EV012_0_TransferPlayer
        $ fade_in()
        call Movement("Bar2EV012_0", "player", ["D","D"]) from _call_Bar2EV012_0_Movement_1
        $ resolve_scene()
        call PauseForBalloon("Bar2EV012_0") from _call_Bar2EV012_0_PauseForBalloon_1
        Leyna "... (Johan hasn't said a word since we've been gone ... I hope it hasn't affected him too much)"
        $ set_self_switch("Bar2","Bar2WowGuysWhatACoincidence","A",True)
    elif menu_choice == _("...."):
        $ menu_choice = None
        ...
        call PlaySound("bgs", "audio/audio follar.ogg", volume=0.9, no_loop=False) from _call_Bar2EV012_0_PlaySound_4
        $ resolve_scene()
        ...
        $ erase_picture(15)
        $ erase_picture(16)
        call TransferPlayer("Town2", "Bar2EV012_0", 28, 22, direction=2) from _call_Bar2EV012_0_TransferPlayer_1
        $ fade_in()
        call Movement("Bar2EV012_0", "player", ["D","D"]) from _call_Bar2EV012_0_Movement_2
        $ resolve_scene()
        call PauseForBalloon("Bar2EV012_0") from _call_Bar2EV012_0_PauseForBalloon_2
        Leyna "... (Johan hasn't said a word since we've been gone ... I hope it hasn't affected him too much)"
        $ set_self_switch("Bar2","Bar2WowGuysWhatACoincidence","A",True)
    $ resolve_scene()
    return False

label Bar2WowGuysWhatACoincidence(play_event = True, trigger = None): # autorun
    if is_erased("Bar2WowGuysWhatACoincidence"):
        return None
    elif self_switch("Bar2","Bar2WowGuysWhatACoincidence","A"):
        return None
    elif trigger == "autorun" and switch("erotic_photos_together"):
        call PlayEvent(play_event, "Bar2WowGuysWhatACoincidence_0", "Bar2WowGuysWhatACoincidence") from _call_Bar2WowGuysWhatACoincidence_0_PlayEvent
        return (0, "", "Bar2WowGuysWhatACoincidence_0")
    return None

label Bar2Eventoanal1_0:
    call Movement("Bar2Eventoanal1_0", "player", ["U","U","U","TURN_R",["WAIT",60],"TURN_L",["WAIT",60],"TURN_U"]) from _call_Bar2Eventoanal1_0_Movement
    $ resolve_scene()
    call PauseForBalloon("Bar2Eventoanal1_0") from _call_Bar2Eventoanal1_0_PauseForBalloon
    Johan "It seems that Leyna has already finished her shift..."
    Johan "Well, since I'm here... it wouldn't hurt me to have a beer"
    call Movement("Bar2Eventoanal1_0", "player", ["L","L","U","TURN_L"]) from _call_Bar2Eventoanal1_0_Movement_1
    $ fade_out()
    call SetEventLocation("Bar2Eventoanal1_0", "Bar2NPCMachine", 4, 8) from _call_Bar2Eventoanal1_0_setloc
    $ fade_in()
    $ resolve_scene()
    ...
    $ fade_out()
    call TransferPlayer("Town2", "Bar2Eventoanal1_0", 11, 47, direction=4) from _call_Bar2Eventoanal1_0_TransferPlayer
    call SetEventLocation("Bar2Eventoanal1_0", "Bar2NPCMachine", 12, 3) from _call_Bar2Eventoanal1_0_setloc_1
    $ fade_in()
    $ resolve_scene()
    ...
    $ fade_out()
    call ChangePartyMember("Leyna", True) from _call_Bar2Eventoanal1_0_ChangePartyMember
    call TransferPlayer("Town2", "Bar2Eventoanal1_0", 20, 29, direction=0) from _call_Bar2Eventoanal1_0_TransferPlayer_1
    call Movement("Bar2Eventoanal1_0", "player", ["R","R","TURN_L"]) from _call_Bar2Eventoanal1_0_Movement_2
    $ fade_in()
    $ resolve_scene()
...
label Bar2Eventoanal1(play_event = True, trigger = None): # autorun
    if is_erased("Bar2Eventoanal1"):
        return None
    elif bar_work >= 4:
        return None
    elif trigger == "autorun" and bar_work >= 3:
        call PlayEvent(play_event, "Bar2Eventoanal1_0", "Bar2Eventoanal1") from _call_Bar2Eventoanal1_0_PlayEvent
        return (0, "", "Bar2Eventoanal1_0")
    return None

label Bar2LeynaWeWereLookingForYou_0(menu_choice = None):
    call Movement("Bar2EV014_0", "player", ["U"]) from _call_Bar2EV014_0_Movement
    $ resolve_scene()
    call PauseForBalloon("Bar2EV014_0") from _call_Bar2EV014_0_PauseForBalloon
    ...
    Villager "hmmm"
    call PlaySound("sound", "audio/Equip2.ogg", volume=0.9, no_loop=True) from _call_Bar2EV014_0_PlaySound
    ...
    if menu_choice == _("sit down"):
        ...
        call PlaySound("music", "audio/Dungeon3.ogg", volume=0.9, no_loop=False) from _call_Bar2EV014_0_PlaySound_1
        $ resolve_scene()
        "Flap flap flap"
        Leyna "Hmmma!"
        ...
        call PlaySound("bgs", "audio/audio follar.ogg", volume=0.9, no_loop=False) from _call_Bar2EV014_0_PlaySound_2
        $ resolve_scene()
        ...
        pause
        $ set_self_switch("Bar2","Bar2LeynaWeWereLookingForYou","A",True)
        $ fade_out()
        $ leyna_poker = 1
        call GalleryViewed("poker") from _call_Bar2EV014_0_GalleryViewed
        ...
        $ erase_picture(48)
        $ erase_picture(49)
        call ChangePartyMember("Johan", True) from _call_Bar2EV014_0_ChangePartyMember
        call ChangePartyMember("Leyna", False) from _call_Bar2EV014_0_ChangePartyMember_1
        $ set_switch("bet_2", True)
        call TransferPlayer("InnRooms", "Bar2EV014_0", 11, 10, direction=2) from _call_Bar2EV014_0_TransferPlayer
        $ fade_in()
        ...
        call PlaySound("music", "audio/Dungeon3.ogg", volume=0.9, no_loop=False) from _call_Bar2EV014_0_PlaySound_3
        $ resolve_scene()
        "Flap flap flap"
        Leyna "Hmmma!"
        Johan "(that's definitely a moan... is .... enjoying it? )"
        ...
        $ erase_picture(39)
        $ erase_picture(40)
        call ChangePartyMember("Johan", True) from _call_Bar2EV014_0_ChangePartyMember_2
        call ChangePartyMember("Leyna", False) from _call_Bar2EV014_0_ChangePartyMember_3
        $ leyna_poker = 2
        $ set_switch("bet_2", True)
        call TransferPlayer("InnRooms", "Bar2EV014_0", 11, 10, direction=2) from _call_Bar2EV014_0_TransferPlayer_1
        $ fade_in()
    $ resolve_scene()
    return False

label Bar2LeynaWeWereLookingForYou(play_event = True, trigger = None): # autorun
    if is_erased("Bar2LeynaWeWereLookingForYou"):
        return None
    elif self_switch("Bar2","Bar2LeynaWeWereLookingForYou","A"):
        return None
    elif trigger == "autorun" and switch("hotsprings_photo_session"):
        call PlayEvent(play_event, "Bar2LeynaWeWereLookingForYou_0", "Bar2LeynaWeWereLookingForYou") from _call_Bar2LeynaWeWereLookingForYou_0_PlayEvent
        return (0, "", "Bar2LeynaWeWereLookingForYou_0")
    return None

label Bar2ToBar2_0:
    $ fade_out()
    call TransferPlayer("Bar2", "Bar2EV015_0", 4, 6, direction=8) from _call_Bar2EV015_0_TransferPlayer
    call Movement("Bar2EV015_0", "player", ["R","TURN_U"]) from _call_Bar2EV015_0_Movement
    call SetEventLocation("Bar2EV015_0", "Bar2barman", 4, 4) from _call_Bar2EV015_0_setloc
    $ fade_in()
    $ resolve_scene()
    call PauseForBalloon("Bar2EV015_0") from _call_Bar2EV015_0_PauseForBalloon
    ...
    if switch("corruption_low"):
        ...
        call GalleryViewed("desayuno") from _call_Bar2EV015_0_GalleryViewed
        $ set_self_switch("Bar2","Bar2ToBar2","A",True)
        call TransferPlayer("Town2", "Bar2EV015_0", 21, 40, direction=8) from _call_Bar2EV015_0_TransferPlayer_1
        $ fade_in()
    if switch("corruption_high"):
        ...
        call PlaySound("bgs", "audio/audio follar.ogg", volume=0.9, no_loop=False) from _call_Bar2EV015_0_PlaySound
        $ resolve_scene()
        ...
        $ erase_picture(18)
        $ set_switch("last_bar", True)
        call GalleryViewed("desayuno") from _call_Bar2EV015_0_GalleryViewed_1
        $ set_self_switch("Bar2","Bar2ToBar2","A",True)
        call TransferPlayer("Town2", "Bar2EV015_0", 21, 40, direction=8) from _call_Bar2EV015_0_TransferPlayer_2
        $ fade_in()
    if switch("corruption_average"):
        $ resolve_scene()
        pause
        ...
        $ erase_picture(11)
        $ set_switch("last_bar", True)
        call GalleryViewed("desayuno") from _call_Bar2EV015_0_GalleryViewed_2
        $ set_self_switch("Bar2","Bar2ToBar2","A",True)
        call TransferPlayer("Town2", "Bar2EV015_0", 21, 40, direction=8) from _call_Bar2EV015_0_TransferPlayer_3
        $ fade_in()
    $ resolve_scene()
    return False

label Bar2ToBar2(play_event = True, trigger = None): # autorun
    if is_erased("Bar2ToBar2"):
        return None
    elif self_switch("Bar2","Bar2ToBar2","A"):
        return None
    elif trigger == "autorun" and switch("breakfast"):
        call PlayEvent(play_event, "Bar2ToBar2_0", "Bar2ToBar2") from _call_Bar2ToBar2_0_PlayEvent
        return (0, "", "Bar2ToBar2_0")
    return None
...
label Bar2LeynawhatAreYouDoingHereIThoughtYouWereLeavingTownThisMorning_0:
    ...
    call PlaySound("sound", "audio/Equip2.ogg", volume=0.9, no_loop=True) from _call_Bar2EV016_0_PlaySound
    $ resolve_scene()
    Leyna "See? I knew it..."
    pause
    ...
    call PlaySound("bgs", "audio/audio follar.ogg", volume=0.9, no_loop=False) from _call_Bar2EV016_0_PlaySound_1
    $ resolve_scene()
    Leyna "Aaah!!"
    ...
    call PlaySound("bgs", "audio/audio follar.ogg", volume=0.9, no_loop=False) from _call_Bar2EV016_0_PlaySound_2
    $ resolve_scene()
    ...
    call GalleryViewed("barfinal") from _call_Bar2EV016_0_GalleryViewed
    $ set_self_switch("Bar2","Bar2LeynawhatAreYouDoingHereIThoughtYouWereLeavingTownThisMorning","A",True)
    ...
    $ erase_picture(12)
    $ erase_picture(13)
    call TransferPlayer("Town2", "Bar2EV016_0", 25, 46, direction=2) from _call_Bar2EV016_0_TransferPlayer
    $ fade_in()
    $ resolve_scene()
    return False

label Bar2LeynawhatAreYouDoingHereIThoughtYouWereLeavingTownThisMorning(play_event = True, trigger = None): # autorun
    if is_erased("Bar2LeynawhatAreYouDoingHereIThoughtYouWereLeavingTownThisMorning"):
        return None
    elif self_switch("Bar2","Bar2LeynawhatAreYouDoingHereIThoughtYouWereLeavingTownThisMorning","A"):
        return None
    elif trigger == "autorun" and switch("festival_final") and switch("corruption_high"):
        call PlayEvent(play_event, "Bar2LeynawhatAreYouDoingHereIThoughtYouWereLeavingTownThisMorning_0", "Bar2LeynawhatAreYouDoingHereIThoughtYouWereLeavingTownThisMorning") from _call_Bar2LeynawhatAreYouDoingHereIThoughtYouWereLeavingTownThisMorning_0_PlayEvent
        return (0, "", "Bar2LeynawhatAreYouDoingHereIThoughtYouWereLeavingTownThisMorning_0")
    return None
