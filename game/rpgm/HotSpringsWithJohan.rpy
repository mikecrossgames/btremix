label HotSpringsWithJohanBG:
    $ set_transparency_backgrounds(["bg_hot_springs"])
    $ set_map_backgrounds(["bg_hot_springs"])
    return

label HotSpringsWithJohanStart:
    call HotSpringsWithJohanBG from _call_HotSpringsWithJohanBG
    stop music
    stop bgs
    return

label HotSpringsWithJohanEnd:
    return

label HotSpringsWithJohanhotspringjuntoscontBase:
    call Movement("HotSpringsWithJohanhotspringjuntoscont", "player", ["D"]) from _call_HotSpringsWithJohanhotspringjuntoscont_Movement
    $ resolve_scene()
    call PauseForBalloon("HotSpringsWithJohanhotspringjuntoscont") from _call_HotSpringsWithJohanhotspringjuntoscont_PauseForBalloon
    ...
    $ fade_out()
    call TransferPlayer("HotSpringsWithJohan", "HotSpringsWithJohanhotspringjuntoscont", 2, 8, direction=6) from _call_HotSpringsWithJohanhotspringjuntoscont_TransferPlayer
    $ fade_in()
    $ resolve_scene()
    call PauseForBalloon("HotSpringsWithJohanhotspringjuntoscont") from _call_HotSpringsWithJohanhotspringjuntoscont_PauseForBalloon_1
    ...
    $ erase_picture(9)
    $ erase_picture(10)
    call ChangePartyMember("Leyna", True) from _call_HotSpringsWithJohanhotspringjuntoscont_ChangePartyMember
    call TransferPlayer("Path", "HotSpringsWithJohanhotspringjuntoscont", 12, 1, direction=2) from _call_HotSpringsWithJohanhotspringjuntoscont_TransferPlayer_1
    $ fade_in()
    call Movement("HotSpringsWithJohanhotspringjuntoscont", "player", ["D","D","TURN_U"]) from _call_HotSpringsWithJohanhotspringjuntoscont_Movement_1
    $ resolve_scene()
    ...
    call GalleryViewed("hotspringsjuntos") from _call_HotSpringsWithJohanhotspringjuntoscont_GalleryViewed
    $ resolve_scene()
    return False

label HotSpringsWithJohanhotspringjuntoscont(play_event = True, trigger = None): # autorun
    if is_erased("HotSpringsWithJohanhotspringjuntoscont"):
        return None
    elif trigger == "autorun":
        call PlayEvent(play_event, "HotSpringsWithJohanhotspringjuntoscontBase", "HotSpringsWithJohanhotspringjuntoscont") from _call_HotSpringsWithJohanhotspringjuntoscont_PlayEvent
        return (0, "", "HotSpringsWithJohanhotspringjuntoscont")
    return None
