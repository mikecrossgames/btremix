...
define gui.name_xpos = 32
define gui.name_ypos = 12
define gui.name_ypos2 = 48
...
## center.
define gui.dialogue_xpos = 32
define gui.dialogue_ypos = 0

## The maximum width of dialogue text, in pixels.
define gui.dialogue_width = 736
...
define gui.choice_button_width = 504
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(64, 8, 64, 8)
define gui.choice_button_text_font = gui.text_font
define gui.choice_button_text_size = 24 # gui.text_size
...
define gui.slot_button_width = 176
define gui.slot_button_height = 132
...
define config.thumbnail_width = 164
define config.thumbnail_height = 92
...
define gui.confirm_frame_borders = Borders(26, 26, 26, 26)

## The frame that is used as part of the skip screen.
define gui.skip_frame_borders = Borders(11, 4, 32, 4)

## The frame that is used as part of the notify screen.
define gui.notify_frame_borders = Borders(11, 4, 26, 4)
...
## speaking character.
define gui.history_name_xpos = 99
define gui.history_name_ypos = 0
define gui.history_name_width = 99
define gui.history_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.history_text_xpos = 109
define gui.history_text_ypos = 2
define gui.history_text_width = 472
...
define gui.nvl_name_width = 96
define gui.nvl_name_xalign = 1.0

## The position, width, and alignment of the dialogue text.
define gui.nvl_text_xpos = 287
define gui.nvl_text_ypos = 6
define gui.nvl_text_width = 377
define gui.nvl_text_xalign = 0.0

## The position, width, and alignment of nvl_thought text (the text said by the
## nvl_narrator character.)
define gui.nvl_thought_xpos = 153
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 498
define gui.nvl_thought_xalign = 0.0

## The position of nvl menu_buttons.
define gui.nvl_button_xpos = 287
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(26, 9, 26, 0)
    ...
    def small():
        ...
        gui.name_xpos = 32
        gui.dialogue_xpos = 58
        gui.dialogue_width = 702

        ## Change the size and spacing of various things.
        gui.slider_size = 23

        gui.choice_button_width = 791
        gui.choice_button_text_size = 20

        gui.navigation_spacing = 13
        gui.pref_button_spacing = 7

        gui.history_height = None # 122
        gui.history_text_width = 440
        ...
        gui.nvl_name_width = 195
        gui.nvl_name_xpos = 208

        gui.nvl_text_width = 584
        gui.nvl_text_xpos = 220
        gui.nvl_text_ypos = 4

        gui.nvl_thought_width = 791
        gui.nvl_thought_xpos = 13

        gui.nvl_button_width = 791
